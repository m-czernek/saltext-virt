...
TEST_DEPENDENCIES = ["looseversion", "tornado", "jinja2", "cryptography"]
...
def tests(session):
    _install_requirements(session, install_source=True, install_extras=TEST_DEPENDENCIES)
...
def docs(session):
    ...
    _install_requirements(
        ...
        install_test_requirements=False,
        install_source=True,
        install_extras=["docs", *TEST_DEPENDENCIES],
    )
    os.chdir("docs/")
