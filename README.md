# Salt Extension for Virt

Salt Extension for interacting with Virt
...
The saltext-virt project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-virt.git
...
* Writing blog posts
* Sharing your experiences using Salt + Virt
  on social media
...
[PRs]: https://github.com/salt-extensions/saltext-virt/pulls
[discussions]: https://github.com/salt-extensions/saltext-virt/discussions
